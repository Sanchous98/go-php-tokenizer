...
const (
	_ItemType_name_0 = "itemErrorTEof"
	...
	_ItemType_name_3 = "T_ELSEIFT_ELSET_LNUMBERT_DNUMBERT_STRINGT_NAME_FULLY_QUALIFIEDT_NAME_RELATIVET_NAME_QUALIFIEDT_VARIABLET_INLINE_HTMLT_ENCAPSED_AND_WHITESPACET_CONSTANT_ENCAPSED_STRINGT_STRING_VARNAMET_NUM_STRINGT_EVALT_NEWT_EXITT_IFT_ENDIFT_ECHOT_DOT_WHILET_ENDWHILET_FORT_ENDFORT_FOREACHT_ENDFOREACHT_DECLARET_ENDDECLARET_AST_SWITCHT_ENDSWITCHT_CASET_DEFAULTT_MATCHT_BREAKT_CONTINUET_GOTOT_FUNCTIONT_FNT_CONSTT_RETURNT_TRYT_CATCHT_FINALLYT_USET_INSTEADOFT_GLOBALT_STATICT_ABSTRACTT_FINALT_PRIVATET_PROTECTEDT_PUBLICT_READONLYT_VART_UNSETT_ISSETT_EMPTYT_HALT_COMPILERT_CLASST_TRAITT_INTERFACET_ENUMT_EXTENDST_IMPLEMENTST_NAMESPACET_LISTT_ARRAYT_CALLABLET_LINET_FILET_DIRT_CLASS_CT_TRAIT_CT_METHOD_CT_FUNC_CT_NS_CT_ATTRIBUTET_INCT_DECT_OBJECT_OPERATORT_NULLSAFE_OBJECT_OPERATORT_COMMENTT_DOC_COMMENTT_OPEN_TAGT_OPEN_TAG_WITH_ECHOT_CLOSE_TAGT_WHITESPACET_START_HEREDOCT_END_HEREDOCT_DOLLAR_OPEN_CURLY_BRACEST_CURLY_OPENT_PAAMAYIM_NEKUDOTAYIMT_NS_SEPARATORT_ELLIPSIS"
)

var (
	_ItemType_index_0 = [...]uint8{0, 9, 13}
